...
if(cluster.isMaster){
	...
	console.clear();
	console.log('\x1b[SENT ATTACK 85%]'.rainbow);          console.log('\x1b[38;5;197mSCRIPT BY \x1b[37m: \x1b[38;5;27mHoaiNam');
	...
	console.log(`[33mPROXYFILE:[0m ${args.proxyFile} | [33mTolta[0m ${proxies.length}`);
}else{
